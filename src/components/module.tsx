      ...
      <div className="container mx-auto px-6">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12 text-left">
            ...
            <div className="bg-gray-800 border border-gray-700 p-8 rounded-lg shadow-lg overflow-hidden group">
              <img 
                src="https://wilgnersilva.com.br/wp-content/webp-express/webp-images/uploads/2025/05/Design-sem-nome-30-768x1024.png.webp" // Substitua este URL pela sua imagem
