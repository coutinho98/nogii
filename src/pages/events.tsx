...
import EventImage from '../assets/images/evento.jpg';
            ...
            <div className="h-full z-10 p-8 rounded-2xl shadow-xl bg-[#0A0A0A] text-center max-w-2xl">
                ...
                <div className="flex flex-col items-center mt-4">
                    <motion.button
                        ...
                        onClick={() => window.open("https://pay.kiwify.com.br/iUitSM9", "_blank", "noopener,noreferrer")}
                    >
                        Compre seu ingresso
                ...
                <div className="relative z-10 w-full mt-12 px-4 flex flex-col md:flex-row justify-center items-center gap-8 max-w-2xl lg:max-w-4xl">
                    ...
                    >
                        ...
                        <p className="text-4xl font-bold font-montserrat mt-2">R$97</p>
